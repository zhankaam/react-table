...
const FilterBar = ({
  ...
  const onApplicationIdChange = useCallback(
  ...
  return (
    <S.Container>
      <Select name="Action Type" options={actionOptions} value={actionType} onChange={onActionTypeChange} />
      <Select
      ...
      />
      <Input name="To Date" placeholder="Select date" type="date" value={endDate} onValueChange={onEndDateChange} />
      <Input
        name="Application ID"
